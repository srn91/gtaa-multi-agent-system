...
A Global Tactical Asset Allocation research system for regime-aware allocation, backtesting, paper trading, and portfolio review.
...
- The implementation combines allocation logic, risk controls, backtesting, and auditable decision artifacts.
